                ...
                <div className="col-12 col-lg-5 px-0 py-5 pb-7">
                    ...
                    <div className="emailBox px-g mb-5 mb-lg-0">
                        ...
                        <div className="col-12 col-lg-8 ms-auto me-auto mt-2 mb-7 mb-lg-0">
                            ...
                            <p className='mt-2 mb-4'>Promotion only applies to the first purchase.</p>
