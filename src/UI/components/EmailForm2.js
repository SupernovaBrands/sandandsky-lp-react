...
const EmailForm = (props) => {
    ...
    return (
        <div className="col-12 col-lg-6 mt-4 pt-0 pt-lg-4 text-center">
            ...
            <p className="mt-2 h4 fw-normal mx-3" dangerouslySetInnerHTML={{ __html: 'Enter your email to view your results! Plus, get a promocode for 10% OFF for your first purchase.' }}></p>
                ...
                <div className="form-group">
                    <form onSubmit={submitEmail}>
                        ...
                        <div className="d-flex pb-2 justify-content-center align-items-center mt-3">
                            ...
                            <label className="font-size-sm mx-1" dangerouslySetInnerHTML={{ __html: 'I agree to Privacy Policy & ToS' }} htmlFor="agree"></label>
                        </div>
